...
const router = createHashRouter([
  {
    ...
    element: <Navbar />,
    children: [
      { index: true, element: <Presentation /> },   // ruta “#/”
      { path: "search",         element: <Search /> },           // “#/search”
      { path: "login",          element: <Login /> },            // “#/login”
      { path: "register",       element: <Register /> },
      { path: "user/userSettings", element: <UserSettings /> },
      { path: "user/loans",     element: <Loans /> },
      { path: "viewBook/:title", element: <ViewBook /> },
      { path: "usersList",      element: <UsersList /> },
      { path: "profile/:email", element: <ViewProfile /> },
      { path: "userBookDetails",element: <UserBooksDetails /> },
      { path: "attributes",     element: <Attributes /> },
      { path: "genres",         element: <Genres /> },
      { path: "authors",        element: <Authors /> },
      { path: "pendingBooks",   element: <PendingBooks /> },
      { path: "bookCopies/:title", element: <BookCopies /> },
