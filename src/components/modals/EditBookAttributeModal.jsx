...
const EditBookAttributeModal = ({
  ...
  switch (editingAttribute) {
    ...
    case "isAdult":
      inputField = (
        ...
        >
          <option value="false" aria-label="No">
            No
          </option>
          <option value="true" aria-label="Yes">
            Yes
          </option>
        </select>
      );
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="editBookAttributeModalTitle"
    >
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 id="editBookAttributeModalTitle" className="modal-title">
          ...
          <div className="modal-body">
            <form
              ...
              aria-describedby="editBookAttributeDescription"
              aria-label="Edit Book Attribute Form"
            >
              <div className="form-group">
                <label htmlFor={inputId} id="editBookAttributeDescription">
                  New Value
                </label>
                {inputField}
              </div>
