...
export default function ReviewList({ title, username }) {
    ...
    return (
        <section className="list-group mb-3" aria-label="Review List Section">
            <InfiniteScroll
                ...
                loader={<Loading />}
                endMessage={
                    <p className="text-center mt-3 text-muted" aria-label="No More Reviews Message">
            ...
            >
                {reviews.map((review) => (
                    <article key={review.id} className="card p-3 mb-4" aria-label={`Review by ${review.userName}`}>
                        ...
                        <p aria-label="Review Rating">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <span
                                    ...
                                    aria-label={`Star ${star} ${star <= review.score ? "filled" : "empty"}`}
                                >
                                    &#9733;
                                </span>
                            ))}
                        </p>
                        <p aria-label="Review Comment">{review.comment}</p>
                        <div className="d-flex justify-content-start">
                            <div className="d-flex align-items-center me-3">
                                ...
                                <p className="mb-0 ms-2" aria-label="Dislike Count">{review.reviewDislikes}</p>
                            </div>
                            <div className="d-flex align-items-center">
                                ...
                                <p className="mb-0 ms-2" aria-label="Like Count">{review.reviewLikes}</p>
                            </div>
                        </div>
                    </article>
                ))}
