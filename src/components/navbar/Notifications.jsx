...
const Notifications = () => {
    ...
    return (
        <div className="notifications" ref={notificationsRef}>
            ...
            >
                {hasUnreadMessages && <span className="notification-unread" aria-label="Unread Notifications Indicator"></span>}
            </button>
            {showNotifications && (
                <div className="notifications-popup my-3 bg-dark" aria-label="Notifications Popup">
                    {messages.length === 0 ? (
